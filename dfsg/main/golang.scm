    ...
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32 "1h9f6kj6ifwgx9hymwkn5w0ri291js1951mlc8fa5lagpbhnqd1g"))
      ...
      (description
       "Camlistore is your personal storage system for life: a way
...
(define-public go-gitea-com-go-chi-binding
  (package
    ...
    (propagated-inputs (list go-github-com-go-chi-chi-v5
                             go-github-com-goccy-go-json
                             go-github-com-unknwon-com))
    (native-inputs (list go-github-com-stretchr-testify))
    (home-page "https://gitea.com/go-chi/binding")
    (synopsis
     "Middleware binding providing request data binding and validation")
    (description
...
(define-public go-gitea-com-go-chi-cache
  (package
    ...
    (propagated-inputs (list go-github-com-bradfitz-gomemcache
...
(define-public go-gitea-com-go-chi-captcha
  (package
    ...
    (propagated-inputs (list go-gitea-com-go-chi-cache
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "00md46ywma7v0czi9zlbwvsqwlhpsivf064ws22a4nli4y0kvimh"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-alicebob-miniredis
  (package
    ...
    (propagated-inputs (list go-github-com-alicebob-gopher-json
...
(define-public go-github-com-antchfx-htmlquery
  (package
    ...
    (propagated-inputs (list go-github-com-antchfx-xpath
...
(define-public go-github-com-antchfx-xmlquery
  (package
    ...
    (propagated-inputs `(("go-github-com-antchfx-xpath" ,go-github-com-antchfx-xpath)
      ...
      #:phases #~(modify-phases %standard-phases
                   (replace 'check
                     (lambda* (#:key inputs #:allow-other-keys #:rest args)
                       (unless  ;The tests fail when run with gccgo.
                         ;; Unable to load timezones.
                         (false-if-exception (search-input-file inputs
                                                                "/bin/gccgo"))
                         (apply (assoc-ref %standard-phases
                                           'check) args)))))))
    (native-inputs (list go-github-com-scylladb-termtables
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "12cwzxzizqf30dxds6yvl8bvb8i58f9jpln3608c6i79kl048xc1"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/blevesearch/bleve"))
    (propagated-inputs `(("go-github-com-blevesearch-go-porterstemmer" ,go-github-com-blevesearch-go-porterstemmer)
  ...
  (package
    ...
    (arguments
     '(#:import-path "github.com/btcsuite/btcutil"
       #:tests? #f))
    (propagated-inputs `(("go-github-com-btcsuite-btcd-btcec" ,go-github-com-btcsuite-btcd-btcec)
                         ...
                         ("go-golang-org-x-crypto" ,go-golang-org-x-crypto)))
    (native-inputs `(("go-github-com-davecgh-go-spew" ,go-github-com-davecgh-go-spew)))
...
(define-public go-github-com-chaseadamsio-goorgeous
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/chaseadamsio/goorgeous"))
    (propagated-inputs (list go-github-com-russross-blackfriday
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "14q1k7fsaq5vd613cbzr2fby9yvxnx3j6bwf3a4h1bk013nmappl"))))
    (build-system go-build-system)
    (arguments
    ...
    (native-inputs (list (specification->package "iptables")))
...
(define-public go-github-com-coreos-go-systemd-util
  (package
    ...
    (propagated-inputs `(("go-github-com-coreos-pkg-dlopen" ,go-github-com-coreos-pkg-dlopen)))
    (synopsis "go-systemd")
    (description #f)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0j8qqw9wwjzidb8nm29dprj320z7wil11cn9wp53awkpw1y4bgq1"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-couchbase-go-couchbase
  (package
    ...
    (propagated-inputs (list go-github-com-couchbase-gomemcached
  ...
  (package
    ...
    (arguments
     '(#:import-path "github.com/couchbase/goutils"
       ...
       #:phases (modify-phases %standard-phases
                  (delete 'build))))
    (propagated-inputs (list go-github-com-pkg-errors go-golang-org-x-crypto))
...
(define-public go-github-com-couchbase-vellum
  (package
    ...
    (propagated-inputs `(("go-github-com-blevesearch-mmap-go" ,go-github-com-blevesearch-mmap-go)
...
(define-public go-github-com-dave-astrid
  (package
    ...
    (native-inputs (list go-github-com-dave-patsy go-golang-org-x-tools))
...
(define-public go-github-com-dave-brenda
  (package
    ...
    (propagated-inputs (list go-github-com-dave-astrid
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1x0a9yyfksmwysaf43crkzv4lmjj6nz147ldkbh496x6jfr7csfs"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "14g8w2vq5jb2w3f14vw5xw1zsn96wiz6iyi3ibfygl4y32zi1pfr"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/dave/gopackages"))
    (propagated-inputs (list go-github-com-dave-kerr))
    (native-inputs (list go-github-com-dave-ktest))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "14s5pc9anmvyzmpd8kmlf7wnaqp2kd5ip7iqyks3wqikaqj32pqn"))))
    (build-system go-build-system)
    (arguments
     '(#:tests? #f ;No clue
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1l3z0ggdcjspfmm6k9glmh52a9x50806k6yldxql73p4bpynsd9g"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1k3y825z02wixxjyamkl63syi2qydsnv49wpgidf0jycykg6ndcv"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0nlls86fx6sxsvwp5k769h5knwh96j8fahhivh6fagzjjyyqcijd"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "121dwkcx1azpn5xqjfn277kg063hx4wfns3jn1vjbvykws2h0ma7"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/gammazero/workerpool"))
    (propagated-inputs `(("go-github-com-gammazero-deque" ,go-github-com-gammazero-deque)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0w67yyc9y11dp7lp4b712dkcgbiln1qmgfx1nbbrw3mfkzr61d7g"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-glycerine-go-unsnap-stream
  (package
    ...
    (native-inputs (list go-github-com-glycerine-goconvey
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "014cj82z42gaw863nrfmw39ff1z103n0aj5bs1fpx2iawgw5i6qh"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-go-enry-go-enry-v2
  (package
    ...
    (native-inputs (list git-minimal go-github-com-stretchr-testify))
...
(define-public go-github-com-go-redis-redis
  (package
    ...
    (native-inputs (list go-github-com-onsi-ginkgo go-github-com-onsi-gomega))
...
(define-public go-github-com-go-testfixtures-testfixtures-v3
  (package
    ...
    (native-inputs (list go-github-com-joho-godotenv))
...
(define-public go-github-com-gocolly-colly
  (package
    ...
    (propagated-inputs (list go-github-com-puerkitobio-goquery
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1ma3mdlhbdalxlc0l82j4lsynqz19d7hp09rim3npbkj9y4wgq4i"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-google-go-github-v32
  (package
    ...
    (propagated-inputs (list go-google-golang-org-appengine
                             ...
                             go-github-com-golang-protobuf))
    (native-inputs (list go-github-com-pmezard-go-difflib))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0fsgnh9xl9jbakk9hj2gmh8sfkgd3ma01qngfgy067ilvqg5x1zb"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/goreleaser/nfpm"))
    (propagated-inputs (list go-mvdan-cc-gofumpt
                             go-gopkg-in-yaml-v3
                             go-gopkg-in-yaml-v2
                             go-golang-org-x-tools
                             go-golang-org-x-sys
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1lwqibra4hyzx0jhaz12rfhfnw73bmdf8cn9r51nqidk8k7zf7sg"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/gorilla/feeds"))
    (native-inputs (list go-github-com-kr-pretty))
...
(define-public go-github-com-gorilla-pat
  (package
    ...
    (propagated-inputs (list go-github-com-gorilla-context
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0xkp5zpqy7siy4p1l8r45csbmif5jv2m0l528mvsxdwpgid8ajij"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-issue9-assert
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/issue9/assert"))
...
(define-public go-github-com-issue9-assert-v2
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/issue9/assert/v2"))
    (home-page "https://github.com/issue9/assert")
    (synopsis "assert")
    (description "Package assert æ¯å¯¹ testing åçä¸äºç®ååè£")
    (license license:expat)))
...
(define-public go-github-com-issue9-identicon
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/issue9/identicon"))
    (propagated-inputs (list go-github-com-issue9-assert-v2))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1wgcm3607zxm2v62dn0rg3b0zy8mlb98s7sbccfhg00di1611ijz"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0nbz8lwr1v2adcpivlfgm9350lkvf9dh5jc8zvg0ap1gjy2if2gh"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0110rc21h06695hlxg4zp3kp21mbw28bpa4rnl944sdqhjzfnsir"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "08ynibh4blfp5nlch6ia8z1chj9zfrcscmldggsyyffg2w5pas85"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/keybase/colly"))
    (propagated-inputs (list go-github-com-gocolly-colly))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1p0s5xc2bkfbgrlsiyz9cf9b9hppzi978gmjppy9gzjh2jii840k"))
       (snippet #~(begin
                    (use-modules (guix build utils))
                    (substitute* '("mount_linux.go" "unmount_linux.go")
                      (("\"fusermount\"")
                       "\"fusermount3\""))))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/keybase/fuse"
       #:phases (modify-phases %standard-phases
                  (delete 'build)
                  (delete 'check))))
    (propagated-inputs (list go-golang-org-x-sys go-github-com-tv42-httpunix))
    (native-inputs `(("fuse" ,(@ (gnu packages linux) fuse))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0z0xb9ss9gn05az3hwiwg4i9x8s0w7nbia3a5zx0mbkiy4kbls1p"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "15jjbc2772jgc1g2sy1a35bl6d3lq0xdfp3zj1kpx30y1fd1553c"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0w8v7xc3v72xpahrmsm4prankvxs9bhgyf68jf4qa0ypq9dicjm2"))))
    (build-system go-build-system)
    (arguments
    ...
    (native-inputs (list go-github-com-reiver-go-telnet))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0jc3wpvj27cqdpl0s5g9dcmk8c6l2r4j39h4i696ylxyjkqbs0fd"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0k67cwhxwmqi7rbk24lpzqgnvj1zc5kvmhpm9xrsi92vay05cvch"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1yxym50n7jhcmgllp01h8p5d04f63m3d0f45hvpacsamss0jgx61"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1jk7aanfrwgshs3h0a15zhjl17fp3jccs3j19z6mrk7xfh65i0wj"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0gqjwv24gh41bm6im1nlc5qf23w7yjy8cbplrv58l86mdcg0h2y9"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1bs7yagq6fzc7k4h4lhhkpjjcqssac85gdfq3rhqfb9asr10wdw1"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "16aqly34lvlvm99q0zv0jqqgyxlksk0czbc485r0zrcw5ynnmq8q"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "12l0adi8rm7y6lyygjbczpix46npggwj410w597ig9axmli2716x"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "064m3a146bc1nhk291a52v7q3l0rfl20s6gzd244wx28z6rzrwrg"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1xkgp7gh61sddbna089hl92l7sdym6js88n5hskaz5clx69sdr5c"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1vw79bmf214inxqpbh36i69jkgb0k1av5ff9j4fqy5ahy5pn6wjn"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1grsgl0z0qrn23s2m9cx2xjilm3yj6x3x10mbagbdp5dq6y9rz5i"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0bvdvb5wvnmy5h6hahi209bzv3in84jnv4dyc4n1nvw7grmmh7al"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/keybase/gomounts"))
    (native-inputs (list go-github-com-strib-gomounts))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0nmawklwj2hmw1xfshn9jyzmjk13pcb3pj7icfp740pc9sp5fa4k"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0zlb90bnv09ybdhbhdbf5j66dhyav9lcbpgmnm2zxv3lrbd0y4gm"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "11j8678cqxjnjldqxhpca5si2r10nrv2z4cd62hfpg59sb8npk7x"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "18h8iabbc7vd161pfkadki5f6hhrwb45vsg22ixmd5b9h3vhxymz"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "181763midr61bc4nmhq4ds6pxsjyw8qnm2mwbhsla10lkfdl9vpm"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "032n758lfycldrrb0ciscrm182jnx4nnqxdkl876scsacxxqm906"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "02qn742g72vf7y2z7zzxl1bxd92q40kq00lva7diyzaj3p1kdwdx"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/keybase/stellarnet"))
    (propagated-inputs `(("go-github-com-sirupsen-logrus" ,go-github-com-sirupsen-logrus)
                         ("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)
                         ("go-golang-org-x-crypto" ,go-golang-org-x-crypto)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0n3wpqqlvqfxy1cw1apswilyfnnc18qgr615k04r8pvzw2vx1icn"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-lafriks-xormstore
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/lafriks/xormstore"))
    (propagated-inputs (list go-xorm-io-xorm go-github-com-gorilla-sessions
                             go-github-com-gorilla-securecookie
                             go-github-com-gorilla-context))
    (native-inputs (list go-github-com-denisenkom-go-mssqldb
                         go-github-com-go-sql-driver-mysql
                         go-github-com-lib-pq go-github-com-mattn-go-sqlite3))
...
(define-public go-github-com-lestrrat-go-backoff-v2
  (package
    ...
    (propagated-inputs (list go-github-com-lestrrat-go-option))
    (native-inputs (list go-github-com-stretchr-testify))
...
(define-public go-github-com-lunny-log
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/lunny/log"))
    (native-inputs (list go-github-com-mattn-go-sqlite3))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1rvbrq1qvfqpajyd3b0kiczvgwrrffc7fdzw7kvnk53a7sb7gwj4"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/manucorporat/sse"
       ;; https://github.com/manucorporat/sse/issues/3
       #:tests? #f))
    (native-inputs `(("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))
                      ...
                      (for-each (lambda (directory)
                                  ((assoc-ref %standard-phases
                                   ...
                                   #:import-path (string-append
                                                  ...
                                                  directory)))
                                (list "clam" "defaults" "randx" "validate"
                                      "wait"))))
                  (replace 'check
                    (lambda* (#:key tests? import-path #:allow-other-keys)
                      (for-each (lambda (directory)
                                ...
                                (list "clam" "defaults" "randx" "validate"
                                      "wait")))))))
    (propagated-inputs (list go-github-com-serenize-snaker
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "04qq2z9gb9rhky62cp0zfd4y16cvjgwyjhk0vpnrxzr90ajyjq46"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0c151l574qclh93pwn9ckq71b4p19iky7yd3ysm0fad8fkhqqq5g"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1gp4wdg5rvcxhnzv55pwd8qvxdk9cq5i0cpcwlx35vqn6v28nyvc"))))
    (build-system go-build-system)
    (arguments
       ...
       #:phases (modify-phases %standard-phases
                  (add-after 'unpack 'remove-some-tests
                    (lambda _
                      ...
                      (delete-file
                       "src/github.com/quasoft/websspi/utf16_test.go"))))))
    (propagated-inputs (list go-golang-org-x-sys
                             go-github-com-gorilla-sessions
                             go-github-com-gorilla-securecookie))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0icqnz0lvpj9ghy5s69x0v2mfb67mjnfyggs1ff14shqjai2p6i2"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "05kgn00l5l1g48ry16l90lghg3x937apb9j7rg12hh2ghkxczha9"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/reiver/go-telnet"))
    (propagated-inputs (list go-github-com-reiver-go-oi))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0czh50md64k9lbllayq0asir3174saxb88yzxrh640yhfxd98pcb"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "04wgxd5dp7azrlhw9qrv4v5j541khw0kgdp4va0rhfylcyggz6k3"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-serenize-snaker
  (package
    ...
    (native-inputs (list go-github-com-onsi-ginkgo))
                                                   ...
                                                   (let ((files (find-files
                                                     ...
                                                     (and (not (null? files))
                                                          ...
                                                          (not (string-contains
                                                                ...
                                                                "go/list2"))
                                                          (not (string-contains
                                                                file "go/rpc")) ;wants network access
                                                          (not (null? (filter-map (lambda 
                                                                                          (test-entry)
                                                                                    (not
                                                                                     (string-contains
                                                                       ...
                                                                       (map (lambda 
                                                                        ...
                                                                        files))))))))
                                            #:directories? #t)))))))
    (native-inputs (list go-github-com-gorilla-websocket))
    (home-page "https://github.com/siddontang/go")
    (synopsis "Collection of Golang libraries")
    (description
     "This package contains a curated collection of Golang libraries.")
    (license license:expat)))
...
(define-public go-github-com-siddontang-goredis
  (package
    ...
    (native-inputs (list go-github-com-alicebob-miniredis))
                                                     ...
                                                     (and (not (null? files))
                                                          ...
                                                          (not (null? (filter-map (lambda 
                                                                       ...
                                                                       (map (lambda 
                                                                        ...
                                                                        files))))))))
                                            #:directories? #t)))))))
    (propagated-inputs (list go-github-com-edsrzf-mmap-go
...
(define-public go-github-com-siddontang-rdb
  (package
    ...
    (propagated-inputs (list go-github-com-cupcake-rdb))
...
(define-public go-github-com-src-d-gcfg
  (package
    ...
    (propagated-inputs `(("go-gopkg-in-warnings" ,go-gopkg-in-warnings-v0)))
...
(define-public go-github-com-stellar-go-address
  (package
    (inherit (go-github-com-stellar-go-package "address"))
    (propagated-inputs `(("go-github-com-asaskevich-govalidator" ,go-github-com-asaskevich-govalidator)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
...
(define-public go-github-com-stellar-go-amount
  (package
    (inherit (go-github-com-stellar-go-package "amount"))
    (propagated-inputs `( ;("go-github-com-stellar-go-support" ,go-github-com-stellar-go-support)
                          ("go-github-com-stellar-go-xdr" ,go-github-com-stellar-go-xdr)))))

(define-public go-github-com-stellar-go-build
  (package
    (inherit (go-github-com-stellar-go-package "build"))
    (propagated-inputs `(("go-github-com-lib-pq" ,go-github-com-lib-pq)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-stellar-go-xdr" ,go-github-com-stellar-go-xdr)
                         ("go-golang-org-x-crypto" ,go-golang-org-x-crypto)))))
...
(define-public go-github-com-stellar-go-clients-federation
  (package
    (inherit (go-github-com-stellar-go-package "clients/federation"))
    (propagated-inputs `(("go-github-com-stellar-go-address" ,go-github-com-stellar-go-address)
    ...
    (native-inputs `( ;("go-github-com-stellar-go-support" ,go-github-com-stellar-go-support)
                      ("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))))

(define-public go-github-com-stellar-go-clients-horizon
  (package
    (inherit (go-github-com-stellar-go-package "clients/horizon"))
    (propagated-inputs `())
    (native-inputs `())))

(define-public go-github-com-stellar-go-clients-horizonclient
  (package
    (inherit (go-github-com-stellar-go-package "clients/horizonclient"))
    (propagated-inputs `(("go-github-com-go-chi-chi" ,go-github-com-go-chi-chi)
                         ("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ...
                         ("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))
    (native-inputs `(("go-github-com-jarcoal-httpmock" ,go-github-com-jarcoal-httpmock)
                     ("go-gopkg-in-gavv-httpexpect-v1" ,go-gopkg-in-gavv-httpexpect-v1)))))

(define-public go-github-com-stellar-go-clients-stellartoml
  (package
    (inherit (go-github-com-stellar-go-package "clients/stellartoml"))
    (propagated-inputs `(("go-github-com-asaskevich-govalidator" ,go-github-com-asaskevich-govalidator)
                         ("go-github-com-burntsushi-toml" ,go-github-com-burntsushi-toml)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))
...
(define-public go-github-com-stellar-go-crc16
  (package
    (inherit (go-github-com-stellar-go-package "crc16"))))

(define-public go-github-com-stellar-go-hash
  (package
    (inherit (go-github-com-stellar-go-package "hash"))
    (native-inputs `(("go-github-com-onsi-ginkgo" ,go-github-com-onsi-ginkgo)
                     ("go-github-com-onsi-gomega" ,go-github-com-onsi-gomega)))))

(define-public go-github-com-stellar-go-keypair
  (package
    (inherit (go-github-com-stellar-go-package "keypair"))
    (propagated-inputs `(("go-github-com-lib-pq" ,go-github-com-lib-pq)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-stellar-go-xdr-xdr3" ,go-github-com-stellar-go-xdr-xdr3)
                         ("go-golang-org-x-crypto" ,go-golang-org-x-crypto)))
...
(define-public go-github-com-stellar-go-network
  (package
    (inherit (go-github-com-stellar-go-package "network"))
    (propagated-inputs `(("go-github-com-lib-pq" ,go-github-com-lib-pq)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-stellar-go-xdr-xdr3" ,go-github-com-stellar-go-xdr-xdr3)))
    (native-inputs `(("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))))
...
(define-public go-github-com-stellar-go-price
  (package
    (inherit (go-github-com-stellar-go-package "price"))
    (propagated-inputs `(("go-github-com-lib-pq" ,go-github-com-lib-pq)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-stellar-go-xdr-xdr3" ,go-github-com-stellar-go-xdr-xdr3)))
    (native-inputs `(("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))))
...
(define-public go-github-com-stellar-go-protocols-federation
  (package
    (inherit (go-github-com-stellar-go-package "protocols/federation"))
    (native-inputs `(("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))))

(define-public go-github-com-stellar-go-protocols-horizon
  (package
    (inherit (go-github-com-stellar-go-package "protocols/horizon"))
    (propagated-inputs `(("go-github-com-go-chi-chi" ,go-github-com-go-chi-chi)
                         ("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ("go-github-com-gorilla-schema" ,go-github-com-gorilla-schema)
                         ("go-github-com-lib-pq" ,go-github-com-lib-pq)
...
(define-public go-github-com-stellar-go-support-log
  (package
    (inherit (go-github-com-stellar-go-package "support/log"))
    (propagated-inputs `(("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-segmentio-go-loggly" ,go-github-com-segmentio-go-loggly)
                         ("go-github-com-sirupsen-logrus" ,go-github-com-sirupsen-logrus)))))
...
(define-public go-github-com-stellar-go-support-render-hal
  (package
    (inherit (go-github-com-stellar-go-package "support/render/hal"))
    (propagated-inputs `(("go-github-com-go-chi-chi" ,go-github-com-go-chi-chi)
                         ("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ("go-github-com-gorilla-schema" ,go-github-com-gorilla-schema)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
...
(define-public go-github-com-stellar-go-support-render-httpjson
  (package
    (inherit (go-github-com-stellar-go-package "support/render/httpjson"))
    (propagated-inputs `(("go-github-com-go-chi-chi" ,go-github-com-go-chi-chi)
                         ("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ("go-github-com-gorilla-schema" ,go-github-com-gorilla-schema)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
...
(define-public go-github-com-stellar-go-support-render-problem
  (package
    (inherit (go-github-com-stellar-go-package "support/render/problem"))
    (propagated-inputs `(("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ("go-github-com-segmentio-go-loggly" ,go-github-com-segmentio-go-loggly)
                         ("go-github-com-sirupsen-logrus" ,go-github-com-sirupsen-logrus)))))
...
(define-public go-github-com-stellar-go-support-url
  (package
    (inherit (go-github-com-stellar-go-package "support/url"))
    (native-inputs `(("go-github-com-stretchr-testify" ,go-github-com-stretchr-testify)))))

(define-public go-github-com-stellar-go-txnbuild
  (package
    (inherit (go-github-com-stellar-go-package "txnbuild"))
    (propagated-inputs `(("go-github-com-lib-pq" ,go-github-com-lib-pq)
                         ("go-github-com-pkg-errors" ,go-github-com-pkg-errors)
                         ;; ("go-github-com-stellar-go-amount" ,go-github-com-stellar-go-amount)
                         ("go-github-com-stellar-go-xdr-xdr3" ,go-github-com-stellar-go-xdr-xdr3)))
    (native-inputs `(("go-github-com-go-chi-chi" ,go-github-com-go-chi-chi)
                     ("go-github-com-go-errors-errors" ,go-github-com-go-errors-errors)
                     ("go-github-com-gorilla-schema" ,go-github-com-gorilla-schema)
                     ("go-github-com-manucorporat-sse" ,go-github-com-manucorporat-sse)
                     ("go-github-com-segmentio-go-loggly" ,go-github-com-segmentio-go-loggly)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1yvqvxgpax53d8m0l97q7k416gpaj33jzzaw5sa3q4kdsb9hl1j8"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0rnmgcsjjv8kwxlk76n7fbigxxnb2y9nk6zqi0yrx0ikcq409qvw"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0brf9k2ynla12gn0237gll6wdi1zk49mxfgwdi4cqccvlfmbkhkc"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0a1bbym8gr9wyanh2br6hmxhdbqpfdr3nb56b4bvglad19fv2fpg"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-toqueteos-webbrowser
  (package
    ...
    (description
     "Webbrowser provides a simple API for opening web pages on your
default browser.")
    (license license:expat)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1yacf9w6vp36hkhl9lq3gk7c551jcsbs348ivv2h3lwkhznldiwl"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "157539vjqkw5r7p8lx0xdykrga1ivwdpv47dywn71swamy02v7jw"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-github-com-unknwon-i18n
  (package
    ...
    (propagated-inputs (list go-gopkg-in-ini-v1 go-github-com-unknwon-com
                             go-github-com-smartystreets-goconvey))
...
(define-public go-github-com-unknwon-paginater
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/unknwon/paginater"))
    (propagated-inputs (list go-github-com-smartystreets-goconvey))
...
(define-public go-github-com-unrolled-render
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/unrolled/render"))
    (propagated-inputs (list go-golang-org-x-sys
                             go-github-com-fsnotify-fsnotify))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0jbhgcxabq9jikwxkrcrp0q4xpl9fisx9rvzgxp5ma97phflw5gb"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/yudai/pp"
       ;; Tests haven't withstood the test of time.
       #:tests? #f))
    (propagated-inputs `(("go-github-com-mattn-go-colorable" ,go-github-com-mattn-go-colorable)
                         ("go-github-com-mattn-go-isatty" ,go-github-com-mattn-go-isatty)))
    (native-inputs `(("go-github-com-k0kubun-colorstring" ,go-github-com-k0kubun-colorstring)))
...
(define-public go-github-com-yuin-goldmark-highlighting
  (package
    ...
    (propagated-inputs (list go-github-com-alecthomas-chroma
...
(define-public go-github-com-zeripath-jwt
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "github.com/zeripath/jwt"))
    (native-inputs (list go-github-com-golang-jwt-jwt))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "00g6nqiiy19djymkixv37f9k3yq87h7z7h840dvvbdrs26n5rxiq"))))
    (build-system go-build-system)
    (arguments
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   (replace 'check
                     (lambda* (#:key inputs #:allow-other-keys #:rest args)
                       (unless  ;The tests try to connect to the network when run with gccgo.
                         (false-if-exception (search-input-file inputs
                                                                "/bin/gccgo"))
                         (apply (assoc-ref %standard-phases
                                           'check) args)))))))
    (propagated-inputs (list go-github-com-golang-protobuf go-golang-org-x-net))
...
(define-public go-gopkg-in-alexcesaro-quotedprintable-v3
  (package
    ...
    (build-system go-build-system)
    (arguments
     '(#:import-path "gopkg.in/alexcesaro/quotedprintable.v3"
       #:unpack-path "gopkg.in/alexcesaro/quotedprintable.v3"))
  ...
  (package
    ...
    (arguments
     '(#:import-path "gopkg.in/gavv/httpexpect.v1"
       #:tests? #f))
    (propagated-inputs (list go-github-com-ajg-form
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0ckvfzj9nhvxi3aznid1wbw0yq5s3k2mfhlqmaz2ll8myzr97w96"))))
    (build-system go-build-system)
    (arguments
     '(#:import-path "gopkg.in/src-d/go-git-fixtures.v3"
       #:phases (modify-phases %standard-phases
                  (delete 'reset-gzip-timestamps))))
    (propagated-inputs `( ;("go-github-com-alcortesm-tgz" ,go-github-com-alcortesm-tgz)
                          ("go-golang-org-x-sys" ,go-golang-org-x-sys)
                         ("go-gopkg-in-check-v1" ,go-gopkg-in-check-v1)
  ...
  (package
    ...
    (arguments
     '(#:import-path "gopkg.in/src-d/go-git.v4"
       ...
       #:tests? #f))
    (propagated-inputs `(("go-github-com-emirpasic-gods" ,go-github-com-emirpasic-gods)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1r8d346szqa9x8q03wiycik5qy3d6w8qq4hs99z1p64q5lm0g7gm"))))
    (build-system go-build-system)
    (arguments
     '(#:tests? #f ;TODO?
                     ...
                     (lambda* (#:key tests? import-path #:allow-other-keys)
                       (for-each (lambda (directory)
                                 ...
                                 (list "cache"
                                       ...
                                       "synlight"
                                       "templates")))))))
    (propagated-inputs (list go-golang-org-x-net ;0.14.0
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "12jf9xkqp0h3crhw7brxhdcqik9vfj4lxb46xdbim9akyzs2qk3z"))))
    (build-system go-build-system)
    (arguments
     '(#:tests? #f ;Tests require network access
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1c68h2a37hzp2smx0b2sbg389fpsgnm1xkcf3x1agl1lh28c90cn"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0w1zb7swn12dnmf07xz57vqhir3bbqpp7jv194ikhdil6016rji0"))))
    (build-system go-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0rl01gmbfp5fnjiflwq85qdiy78fa1myxkm0d9vvrrgd1jbx3k03"))))
    (build-system go-build-system)
    (arguments
     `(#:tests? #f ;Tests hang forever
       #:import-path "modernc.org/sqlite"))
    (propagated-inputs (list go-modernc-org-tcl
                             go-modernc-org-mathutil
                             go-modernc-org-libc
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "00ncfrq3dp1krhr8360y6n0v3vx3mcgmi2f7gpmc5hlprcamsbxl"))))
    (build-system go-build-system)
    (arguments
...
(define-public go-xorm-io-builder
  (package
    ...
    (propagated-inputs (list go-gitea-com-xorm-sqlfiddle))
    (native-inputs (list go-github-com-stretchr-testify))
